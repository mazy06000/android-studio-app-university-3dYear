...
public class HorizontalExpansionLayout extends HorizontalScrollView {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            final TypedArray a = context.obtainStyledAttributes(attrs, com.example.plpla.R.styleable.ExpansionLayout);
            if (a != null) {
                expanded = a.getBoolean(com.example.plpla.R.styleable.ExpansionLayout_expansion_expanded, expanded);
                a.recycle();
            }
        }
    }
